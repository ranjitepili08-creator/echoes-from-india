...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0b0e] text-[#f0f2f5] flex flex-col font-sans selection:bg-white/20 selection:text-white pb-20">
      ...
      <footer className="border-t border-white/10 bg-[#0a0b0e] py-8 px-6 sm:px-12 text-xs text-[#8e95a5]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[11px] text-[#646c7c] block">
                Preserving Ancient Indian Musical Heritage through AI Vision &amp; Organological Timbre Synthesis
              </span>
            </div>
          </div>

          <div className="flex items-center flex-wrap justify-center gap-4 text-center text-[12px] text-[#9da4b0]">
            <span>Canonical Treatises: <em>Natya Shastra &amp; Sangita Ratnakara</em></span>
            <span>•</span>
            <span>Created by <strong>Ranjeet</strong></span>
          </div>

          <div className="text-[11px] text-[#646c7c]">
            Digital Heritage &amp; Acoustic Preservation Archive
          </div>
        </div>
      </footer>
